...
// Cloud Run環境用のパス設定
const WORK_DIR = '/app/mulmocast-cli';
...
function generateMovie() {
  try {
    ...
    // Cloud Run環境では、mulmocast-cliが利用できない場合の代替処理
    // この部分は実際のmulmocast-cli環境に合わせて調整が必要
    console.log('⚠️ Cloud Run環境では動画生成をスキップします');
    
    // ダミーファイルを作成（実際の環境では削除）
